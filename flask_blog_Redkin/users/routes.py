...
from flask_blog_Redkin import db, bcrypt
from flask_blog_Redkin.models import User, Post
from flask_blog_Redkin.users.forms import RegistrationForm, LoginForm, \
    UpdateAccountForm, RequestResetPasswordForm, ResetPasswordForm
from flask_blog_Redkin.users.utils import save_picture, send_reset_email
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password,
            ...
            return redirect(url_for('main.index')) if next_page else redirect(url_for('posts.allpost'))
